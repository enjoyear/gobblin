...
public class GoogleAdWordsExtractorTest {
  @Test
  public void testGetDownloadFields1() throws IOException {
  ...
  @Test
  public void testGetDownloadFields2() throws IOException {
    HashMap<String, String> fields = new HashMap<>();
    fields.put("c1", "String");
  ...
  public void testGetDownloadFieldsWhenColumnNotExist() throws IOException {
    HashMap<String, String> fields = new HashMap<>();
    fields.put("c1", "String");
